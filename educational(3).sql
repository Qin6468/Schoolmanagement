...
CREATE TABLE `cc`  (
  ...
  CONSTRAINT `c_id` FOREIGN KEY (`c_id`) REFERENCES `course` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
-- Records of course
-- ----------------------------
INSERT INTO `course` VALUES (1, 0, '语文', '文法学院', 4, 64, 20, '第1周到第14周，星期一，第1节到第4节', '教103', '语文');
INSERT INTO `course` VALUES (2, 0, '英语', '文法学院', 4, 64, 20, '第1周到第14周，星期二，第6节到第9节', '教203', 'English');
INSERT INTO `course` VALUES (3, 0, '数学', '理学院', 5, 80, 20, '第1周到第16周，星期三，第1节到第4节', '教302', '数学');
INSERT INTO `course` VALUES (4, 0, '程序设计', '信息学院', 4, 64, 30, '第1周到第14周，星期四，第6节到第9节', '科103', '程序');
INSERT INTO `course` VALUES (5, 0, '历史', '历史学院', 2, 32, 10, '第5周到第12周，第10节到第12节', '科503', '历史');
...
CREATE TABLE `evaluation`  (
  ...
  CONSTRAINT `c_id1` FOREIGN KEY (`c_id`) REFERENCES `course` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
CREATE TABLE `sc`  (
  ...
  CONSTRAINT `cid2` FOREIGN KEY (`c_id`) REFERENCES `course` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
CREATE TABLE `tc`  (
  ...
  CONSTRAINT `cid3` FOREIGN KEY (`c_id`) REFERENCES `course` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
