...
CREATE TABLE `course`  (
  ...
  `semester_hour` int(11) NOT NULL COMMENT '学时',
...
CREATE TABLE `evaluation`  (
  ...
  `c_id` int(11) NOT NULL COMMENT '课程id',
  `score1` int(11) NOT NULL COMMENT '教学态度',
  `score2` int(11) NOT NULL COMMENT '教学效果',
  `score3` int(11) NOT NULL COMMENT '作业安排',
  `score4` int(11) NOT NULL COMMENT '教案准备',
  `score5` int(11) NOT NULL COMMENT '道德规范',
...
) ENGINE = InnoDB AUTO_INCREMENT = 10 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '分数表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `thesis`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `t_id` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '课题id',
  `sid` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '学生id',
  `tid` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '老师id',
  `topic` char(20) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '选题题目',
  `info` text CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '简介',
  `status` int(11) NOT NULL COMMENT '选题状态，0为未选，1为已选',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `uid1`(`sid`) USING BTREE,
...
-- Records of thesis
-- ----------------------------
INSERT INTO `thesis` VALUES (1, '1', '2020124152300', '35', 'web开发', 'web，js，php', 1);
INSERT INTO `thesis` VALUES (2, '2', '2020124152444', '34', '唐朝历史研究', '唐朝', 0);
